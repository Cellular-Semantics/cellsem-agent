...
@dataclass
class CellDependencies(HasWorkdir):
...
def get_config() -> CellDependencies:
    """
    Get the Cell agent configuration from environment variables or defaults.

    Returns:
        A CellDependencies instance with default settings.
